...
(function() {
  ...
  const i18nData = {
    en: {
      ...
      "hero.role.cs_short": "Customer Care",
      "hero.role.dev": "Full Stack Developer",
      "hero.role.dev_short": "Full Stack Dev",
      "hero.role.it": "IT & Automation Specialist",
      "hero.role.it_short": "IT & Automation",
      "hero.status_online": "Available",
    ...
    ar: {
      ...
      "hero.role.cs_short": "خدمة العملاء",
      "hero.role.dev": "مطور Full Stack",
      "hero.role.dev_short": "مطور Full Stack",
      "hero.role.it": "أخصائي IT وأتمتة",
      "hero.role.it_short": "IT وأتمتة",
      "hero.status_online": "متواجد الآن",
      "hero.cta": "تواصل معي",
    ...
    es: {
      ...
      "hero.role.cs_short": "Atención al Cliente",
      "hero.role.dev": "Desarrollador Full Stack",
      "hero.role.dev_short": "Full Stack Dev",
      "hero.role.it": "Informática y Automatización",
      "hero.role.it_short": "IT y Automatización",
      "hero.status_online": "Disponible",
      "hero.cta": "Contactar",
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // 4. Contact Copy Shortcuts & Direct Row Navigation
    ...
    // 4b. Direct Clickable Rows (Email & WhatsApp bars)
    document.querySelectorAll('.neo-contact-item[data-href]').forEach(row => {
