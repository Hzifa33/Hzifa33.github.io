(function(){const modules={"./QR8bitByte":function(module,exports,require){
...
}},cache={};function require(k){k=k.replace(/\.js$/,'');if(cache[k])return cache[k].exports;const m=cache[k]={exports:{}};modules[k](m,m.exports,require);return m.exports}window.HozQRMatrix=require('./index');window.HozQRLevels=require('./QRErrorCorrectLevel')})();